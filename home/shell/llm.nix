{
  ...
  #   ${lib.getExe pkgs.llm} models default openrouter/google/gemini-2.5-flash 2>/dev/null || true
  ...
  #   ${lib.getExe pkgs.llm} models options set g3 unlimited 1 2>/dev/null
  #   ${lib.getExe pkgs.llm} models options set gl unlimited 1 2>/dev/null
  #   ${lib.getExe pkgs.llm} models options set gf unlimited 1 2>/dev/null
  # '';
}
