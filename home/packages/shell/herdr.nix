{
  ...
  programs.herdr = {
    enable = true;
    package = import ./herdr-package.nix {inherit inputs pkgs;};
    ...
    settings = {
      ...
      theme = {
        ...
        custom = {
          ...
          pane_active_border = "gray";
          pane_inactive_border = "darkgray";
      ...
      keys = {
        ...
        next_agent = "prefix+]";
        new_worktree = "prefix+shift+t";
        open_worktree = "prefix+shift+w";
