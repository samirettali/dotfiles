...
Eleven skills require explicit invocation rather than automatic discovery:

- `autoresearch-create`, `autoresearch-finalize`, `autoresearch-hooks`
- `generate-music`, `generate-speech`, `ideas`
- `live-ui-variants`, `show-me`, `neovim`, `remotion-best-practices`, `tavily`
...
The eight shared skills also carry `policy.allow_implicit_invocation: false`
...
eleven skills remain discoverable as commands but not in `formatSkillsForPrompt`.
